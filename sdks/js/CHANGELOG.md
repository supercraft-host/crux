...
### Notes
- This is the same code path as the in-house pre-release SDK; behaviour
  is unchanged. The version bump to a documented `1.0.0` reflects the
  switch to an open-source release cycle.
